...
logo_text.append("\nWAYEN TOOL", style="bold white on blue")
logo_text.append("    ")
logo_text.append("@sshh9\n\n", style="bold magenta")
console.print(Panel(logo_text, title="Welcome", subtitle="Wayen TOOL", expand=False, box=box.ROUNDED))
print('')
...
if total_saved > 0:
    ...
    console.print('No usernames were fetched.', style="bold yellow")        'Sec-Ch-Ua': '"Not.A/Brand";v="8", "Chromium";v="114", "Microsoft Edge";v="114"',
        'Sec-Ch-Ua-Full-Version-List': '"Not.A/Brand";v="8.0.0.0", "Chromium";v="114.0.5735.201", "Microsoft Edge";v="114.0.1823.67"',
        'Sec-Ch-Ua-Mobile': '?0',
        'Sec-Ch-Ua-Platform': '"Windows"',
        'Sec-Ch-Ua-Platform-Version': '"15.0.0"',
